...
public class SettingsMenu : MonoBehaviour {
    ...
    void Awake() {
        ...
        //sensitivityX.value = settingsData.mouseSensitivityX;
        //sensitivityY.value = settingsData.mouseSensitivityY;
        //// Interface
        ...
        //distanceConstantSlider.value = settingsData.distanceConstant;
        //velocityConstantSlider.value = settingsData.velocityConstant;
        //forceConstantSlider.value = settingsData.allomanticConstant;
        //maxRangeSlider.value = settingsData.maxPushRange;
        //// World
